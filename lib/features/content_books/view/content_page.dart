      ...
      body: SafeArea(
        child: BlocProvider(
          create: (context) => ContentCubit(
              bookId: widget.bookId, repository: BookDatabaseHelper()),
                  ...
                  children: [
                    Flex(
                        ...
                        children: [
                          ...
                          EsaySize.gap(5),
                          SizedBox(
                            width: vertical ? 15 : EsaySize.width(context),
                            height: vertical ? EsaySize.height(context) : 15,
                            child: FlutterSlider(
